...
export const mockReviewItems: ReviewItem[] = [
  {
    ...
    ai_scores: { spelling: true, distractor: true, pedagogical: true },
    ai_flags: [],
    status: 'ai_passed',
  ...
  },
  {
    ...
    ai_scores: { spelling: true, distractor: false, pedagogical: true },
    ai_flags: ['B'],
    status: 'ai_flagged',
  ...
  },
  {
    ...
    ai_scores: { spelling: false, distractor: true, pedagogical: true },
    ai_flags: ['A', 'C1'],
    status: 'ai_flagged',
  ...
  },
  {
    ...
    task: {
      ...
      review_after_days: [1, 3],
      lesson_slot_fit: 'END',
      feedback_text: 'Гайхалтай! Зөв сонссон.',
    },
    ai_scores: { spelling: null, distractor: null, pedagogical: null },
    ai_flags: [],
    status: 'pending',
